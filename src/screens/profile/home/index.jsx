          ...
          <TouchableOpacity onPress={() => navigation.navigate('Addresses')}>
            <View style={styles.sectionItem}>
              <View style={styles.sectionItemLeft}>
                ...
                <Text style={styles.sectionItemText}>Endereços</Text>
              </View>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('Cards')}>
            <View style={styles.sectionItem}>
              <View style={styles.sectionItemLeft}>
                ...
                <Text style={styles.sectionItemText}>Pagamento</Text>
              </View>
              <MaterialIcons name="keyboard-arrow-right" size={24} color={theme.colors.black} />
            </View>
          </TouchableOpacity>
          ...
          <TouchableOpacity onPress={() => navigation.navigate('Information')}>
            <View style={styles.sectionItem}>
              <View style={styles.sectionItemLeft}>
                ...
                <Text style={styles.sectionItemText}>Informações</Text>
              </View>
              <MaterialIcons name="keyboard-arrow-right" size={24} color={theme.colors.black} />
            </View>
          </TouchableOpacity>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.sectionItem}>
            <View style={styles.sectionItemLeft}>
              ...
              <Text style={styles.sectionItemText}>Ativar notificações</Text>
            </View>
